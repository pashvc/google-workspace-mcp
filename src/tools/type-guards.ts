...
// Base Tool Arguments
export function isBaseToolArguments(
  args: Record<string, unknown>
): args is BaseToolArguments {
  return typeof args.email === "string";
}

export function assertBaseToolArguments(
  args: Record<string, unknown>
): asserts args is BaseToolArguments {
...
export function isCalendarEventParams(
  args: Record<string, unknown>
): args is CalendarEventParams {
  return (
...
export function assertCalendarEventParams(
  args: Record<string, unknown>
): asserts args is CalendarEventParams {
  if (!isCalendarEventParams(args)) {
    throw new Error("Invalid calendar event parameters");
  }
}

export function isEmailEventIdArgs(
  args: Record<string, unknown>
): args is { email: string; eventId: string } {
  return typeof args.email === "string" && typeof args.eventId === "string";
}

export function assertEmailEventIdArgs(
  args: Record<string, unknown>
): asserts args is { email: string; eventId: string } {
...
// Gmail Type Guards
export function isSendEmailArgs(
  args: Record<string, unknown>
): args is SendEmailArgs {
  return (
    typeof args.email === "string" &&
    ...
    (args.cc === undefined ||
      (Array.isArray(args.cc) &&
        args.cc.every((cc) => typeof cc === "string"))) &&
    (args.bcc === undefined ||
      (Array.isArray(args.bcc) &&
        args.bcc.every((bcc) => typeof bcc === "string")))
  );
}

export function assertSendEmailArgs(
  args: Record<string, unknown>
): asserts args is SendEmailArgs {
  if (!isSendEmailArgs(args)) {
    throw new Error(
      "Invalid email parameters. Required: email, to, subject, body"
    );
  }
}
  ...
  return (
    ...
    (params.options === undefined ||
      (() => {
        ...
        return (
          (opts.folderId === undefined || typeof opts.folderId === "string") &&
          ...
          (opts.orderBy === undefined ||
            (Array.isArray(opts.orderBy) &&
              opts.orderBy.every((o: unknown) => typeof o === "string"))) &&
          (opts.fields === undefined ||
            (Array.isArray(opts.fields) &&
              opts.fields.every((f: unknown) => typeof f === "string")))
        );
      })())
  );
}

export function assertDriveFileListArgs(
  args: unknown
): asserts args is DriveFileListArgs {
...
export function isDriveSearchArgs(args: unknown): args is DriveSearchArgs {
  ...
  return (
    ...
    params.options !== null &&
    (params.options.fullText === undefined ||
      typeof params.options.fullText === "string") &&
    (params.options.mimeType === undefined ||
      typeof params.options.mimeType === "string") &&
    (params.options.folderId === undefined ||
      typeof params.options.folderId === "string") &&
    (params.options.trashed === undefined ||
      typeof params.options.trashed === "boolean") &&
    (params.options.query === undefined ||
      typeof params.options.query === "string") &&
    (params.options.pageSize === undefined ||
      typeof params.options.pageSize === "number")
  );
}

export function assertDriveSearchArgs(
  args: unknown
): asserts args is DriveSearchArgs {
...
export function isDriveUploadArgs(args: unknown): args is DriveUploadArgs {
  ...
  return (
    ...
    (params.options.mimeType === undefined ||
      typeof params.options.mimeType === "string") &&
    (params.options.parents === undefined ||
      (Array.isArray(params.options.parents) &&
        params.options.parents.every((p) => typeof p === "string")))
  );
}

export function assertDriveUploadArgs(
  args: unknown
): asserts args is DriveUploadArgs {
  if (!isDriveUploadArgs(args)) {
    throw new Error(
      "Invalid upload parameters. Required: email, options.name, options.content"
    );
  }
}
...
export function assertDriveDownloadArgs(
  args: unknown
): asserts args is DriveDownloadArgs {
...
export function assertDriveFolderArgs(
  args: unknown
): asserts args is DriveFolderArgs {
  if (!isDriveFolderArgs(args)) {
    throw new Error("Invalid folder parameters. Required: email, name");
  }
}

export function isDrivePermissionArgs(
  args: unknown
): args is DrivePermissionArgs {
  if (typeof args !== "object" || args === null) return false;
  ...
  return (
    ...
    [
      ...
      "commenter",
      "reader",
    ].includes(params.options.role) &&
    ["user", "group", "domain", "anyone"].includes(params.options.type) &&
    (params.options.emailAddress === undefined ||
      typeof params.options.emailAddress === "string") &&
    (params.options.domain === undefined ||
      typeof params.options.domain === "string") &&
    (params.options.allowFileDiscovery === undefined ||
      typeof params.options.allowFileDiscovery === "boolean")
  );
}

export function assertDrivePermissionArgs(
  args: unknown
): asserts args is DrivePermissionArgs {
  if (!isDrivePermissionArgs(args)) {
    throw new Error(
      "Invalid permission parameters. Required: email, options.fileId, options.role, options.type"
    );
  }
}
...
export function isDriveDeleteArgs(args: unknown): args is DriveDeleteArgs {
  ...
  return typeof params.email === "string" && typeof params.fileId === "string";
}

export function assertDriveDeleteArgs(
  args: unknown
): asserts args is DriveDeleteArgs {
    ...
    (params.data === undefined ||
      (() => {
        ...
        return (
          ...
          (data.messageListVisibility === undefined ||
            ["show", "hide"].includes(data.messageListVisibility)) &&
          (data.labelListVisibility === undefined ||
            ["labelShow", "labelHide", "labelShowIfUnread"].includes(
...
export function assertManageLabelParams(
  args: unknown
): asserts args is ManageLabelParams {
  if (!isManageLabelParams(args)) {
    throw new Error(
      "Invalid label management parameters. Required: email, action"
    );
  }
}

export function isManageLabelAssignmentParams(
  args: unknown
): args is ManageLabelAssignmentParams {
  if (typeof args !== "object" || args === null) return false;
...
export function assertManageLabelAssignmentParams(
  args: unknown
): asserts args is ManageLabelAssignmentParams {
  if (!isManageLabelAssignmentParams(args)) {
    throw new Error(
      "Invalid label assignment parameters. Required: email, action, messageId, labelIds"
    );
  }
}

export function isManageLabelFilterParams(
  args: unknown
): args is ManageLabelFilterParams {
  if (typeof args !== "object" || args === null) return false;
...
export function assertManageLabelFilterParams(
  args: unknown
): asserts args is ManageLabelFilterParams {
        ...
        return (
          ...
          (data.references === undefined ||
            (Array.isArray(data.references) &&
              data.references.every((ref) => typeof ref === "string"))) &&
...
export function isManageAttachmentParams(
  args: unknown
): args is ManageAttachmentParams {
  if (typeof args !== "object" || args === null) return false;
...
export function assertManageAttachmentParams(
  args: unknown
): asserts args is ManageAttachmentParams {
...
export function assertManageDraftParams(
  args: unknown
): asserts args is ManageDraftParams {
  if (!isManageDraftParams(args)) {
    throw new Error(
      "Invalid draft management parameters. Required: email, action"
    );
  }
}

// Contacts Type Guards
export function isGetContactsParams(
  args: Record<string, unknown>
): args is GetContactsParams {
  return (
    typeof args.email === "string" &&
    typeof args.personFields === "string" &&
    (args.pageSize === undefined || typeof args.pageSize === "number") &&
    (args.pageToken === undefined || typeof args.pageToken === "string")
  );
}

export function assertGetContactsParams(
  args: Record<string, unknown>
): asserts args is GetContactsParams {
  if (!isGetContactsParams(args)) {
    throw new Error(
      "Invalid contacts parameters. Required: email, personFields"
    );
  }
}
