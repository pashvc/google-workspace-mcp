    ...
    inputSchema: {
      ...
      properties: {
        ...
        auth_code: {
          type: "string",
          description:
            "Authorization code from Google OAuth (for initial authentication)",
        },
      },
      required: ["email"],
    },
        ...
        search: {
          ...
          properties: {
            ...
            content: {
              type: "string",
              description:
                'Complex Gmail search query with full operator support (e.g., "from:(alice OR bob) subject:(meeting OR sync)")',
            },
            after: {
              type: "string",
              description:
                'Search emails after this date in YYYY-MM-DD format (e.g., "2024-01-01")',
            },
            before: {
              type: "string",
              description:
                'Search emails before this date in YYYY-MM-DD format (e.g., "2024-12-31")',
            },
            hasAttachment: {
              type: "boolean",
            ...
            labels: {
              ...
              items: { type: "string" },
              description:
                "Include emails with these labels (e.g., INBOX, SENT, IMPORTANT)",
            },
            excludeLabels: {
              type: "array",
              items: { type: "string" },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        start: {
          ...
          properties: {
            dateTime: {
              type: "string",
              description:
                'Event start time as ISO-8601 string (e.g., "2024-02-18T15:30:00-06:00")',
            },
            timeZone: {
              type: "string",
              description:
        ...
        recurrence: {
          ...
          items: { type: "string" },
          description:
            'RRULE strings for recurring events (e.g., ["RRULE:FREQ=WEEKLY"])',
        },
      },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        personFields: {
          type: "string",
          description:
            'Comma-separated fields to include in the response (e.g., "names,emailAddresses,phoneNumbers")',
        },
        pageSize: {
          type: "number",
