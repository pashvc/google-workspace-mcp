      ...
      async (request, extra) => {
        try {
          ...
          if (!tool) {
            ...
            const errorMessage =
              this.toolRegistry.formatErrorWithSuggestions(toolName);
          ...
          switch (tool.name) {
            ...
            case "authenticate_workspace_account":
              result = await handleAuthenticateWorkspaceAccount(
                args as AuthenticateAccountArgs
              );
              break;
            ...
            case "manage_workspace_draft":
              ...
              result = await handleManageWorkspaceDraft(
                args as ManageDraftParams
              );
              break;
            ...
            case "manage_workspace_attachment":
              ...
              result = await handleManageWorkspaceAttachment(
                args as ManageAttachmentParams
              );
              break;
            ...
            case "list_workspace_calendar_events":
              ...
              result = await handleListWorkspaceCalendarEvents(
                args as CalendarEventParams
              );
              break;
            ...
            case "manage_workspace_label":
              ...
              result = await handleManageWorkspaceLabel(
                args as unknown as ManageLabelParams
              );
              break;
            case "manage_workspace_label_assignment":
              assertManageLabelAssignmentParams(args);
              result = await handleManageWorkspaceLabelAssignment(
                args as unknown as ManageLabelAssignmentParams
              );
              break;
            case "manage_workspace_label_filter":
              assertManageLabelFilterParams(args);
              result = await handleManageWorkspaceLabelFilter(
                args as unknown as ManageLabelFilterParams
              );
              break;
